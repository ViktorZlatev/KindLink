                            ...
                            child: Form(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text("Join KindLink and start making a difference", style: GoogleFonts.poppins(fontSize: 13, color: Colors.white.withValues(alpha: 0.4))),
                                  ...
                                  _DarkField(
                                    ...
                                    suffix: GestureDetector(onTap: () => setState(() => _showPassword = !_showPassword),
                                      child: Icon(_showPassword ? Icons.visibility_off_outlined : Icons.visibility_outlined, size: 17, color: Colors.white.withValues(alpha: 0.3))),
                                  ...
                                  _DarkField(
                                    ...
                                    suffix: GestureDetector(onTap: () => setState(() => _showConfirm = !_showConfirm),
                                      child: Icon(_showConfirm ? Icons.visibility_off_outlined : Icons.visibility_outlined, size: 17, color: Colors.white.withValues(alpha: 0.3))),
