                      ...
                      child: Wrap(
                        ...
                        children: [
                          _infoCard(
                            ...
                            title: "Help Nearby",
                            text: "Find and support people in your local area who need a helping hand.",
                          ),
                          _infoCard(
                            icon: Icons.verified_outlined,
                            title: "Trusted & Safe",
                            text: "Verified volunteers and transparent feedback create a secure community.",
                          ),
                          _infoCard(
                            icon: Icons.map_outlined,
                            title: "Real-Time Map",
                            text: "Discover nearby opportunities instantly with our Sofia map integration.",
                          ),
                        ],
                      ),
                    ),
      ...
      child: MouseRegion(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(color: filled ? Colors.transparent : Colors.white, width: 2),
            boxShadow: filled
                ? [
                    BoxShadow(
